<html>
    <title>Busqueda completada</title>
    <?php include '../plantilla/headerBuscar.php'; ?>    
    ...
    <table id="customers"> 
        ...
        <?php
        foreach ($rs as $reg) {//saco los datos de la consulta,  los datos vienen del controlador controladorPaginarBuscador
            ...
            <tr>
                ...
                if ($_SESSION["admin"]) {// si el que hace login es admin
                    ...
                    //  operatio se imprime el campo completar
                    ?>
                    <td><a  href="/../proyecto/controlador/controladorEditar.php?id=<?= $reg["Id"] ?>"><img src="../Assets/img/edit.png" alt="idk"/></a></td>
                    <td><a  href="/../proyecto/controlador/controladorEliminar.php?id=<?= $reg["Id"] ?>"><img src="../Assets/img/del2.png" alt="idk"/></a></td>
                    <?php
                } else {
                    ?>
                    <td><a  href="/../proyecto/controlador/controladorCompletar.php?id=<?= $reg["Id"] ?>"><img src="../Assets/img/check.png" alt="idk"/></a></td>            
    ...
    <div class="pagination"> 
        <?php
        $controlador = "controladorPaginarBuscador.php";//paso por una variable el nombre del controlador
