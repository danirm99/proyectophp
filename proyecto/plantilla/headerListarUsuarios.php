...
?>
<div class="topnav">
    <img src="../Assets/img/<?php echo $nombre ?>.png" alt="imagen" class="user" >
    <img src="../Assets/img/title.png" class="center" alt="imagen2" >
...
<nav>        
    ...
    ?>
    <div class="animation start-userlist"></div>
</nav>